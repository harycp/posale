        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('cashier.products.update', $product->id) }}"
                        enctype="multipart/form-data" x-data="{ imagePreview: '{{ $product->image ? Storage::url($product->image) : null }}' }">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Stok Saat Ini -->
                            <div>
                                <label for="stock" class="block text-sm font-medium text-gray-700">Stok Saat
                                    Ini</label>
